#  Smooth, low-noise surface — RBF + small noise
CONFIG_SMOOTH = {
...
#  Rougher / possibly non‑smooth surface — Matérn kernel (nu=2.5) + moderate noise
CONFIG_ROUGH = {
    "dim": None,
    "kernel_type": "matern",
    "add_white": True,
...
CONFIG_LIST = [
    ...
    #  Smooth, low‑noise — isotropic RBF
    {
    ...
    #  Rougher surface — isotropic Matern (nu = 2.5)
    {
    ...
    #  Rough + smooth mixed — hybrid RBF + Matern (gives flexibility)
    {
    ...
    #  Anisotropic — per-dimension length-scales (RBF)
    {
    ...
    #  Conservative + regularised — RBF + White noise + modest hyperparameter search
    {
    ...
    # High flexibility — Matern anisotropic + wide bounds
    {
    ...
    #  Smooth + safe noise floor — RBF + high noise floor (for possibly noisy data)
    {
    ...
    #  Basic fallback — default kernel (let GP optimize defaults)
    {
