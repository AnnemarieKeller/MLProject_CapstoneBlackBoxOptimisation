...
|-----------|----------------|-----------|
| Review of GP surrogate modeling + validation methods / metrics | [Probabilistic surrogate modeling by Gaussian process: A review on recent insights in estimation and validation (2024), Reliability Engineering & System Safety — DOI 10.1016/j.ress.2024.110094](https://www.sciencedirect.com/science/article/pii/S095183202400110094) | Survey of GP surrogate modeling: covers hyperparameter estimation methods, common pitfalls of GP modelling with small data, and validation criteria for predictive distributions (not just mean). Useful for justifying diagnostics like variance, interval quality, and hyperparameter sanity checks. |
| Conformal‑prediction to build calibrated intervals and evaluate GP surrogate coverage | [Conformal Approach To Gaussian Process Surrogate Evaluation With Coverage Guarantees (2024, arXiv)](https://arxiv.org/pdf/2401.07733) | Explains how conformal prediction can provide calibrated uncertainty intervals and validate GP surrogate coverage. Useful to ensure predictive uncertainty is reliable. |
| On the role of model uncertainties in Bayesian optimisation (2023) | [On the role of model uncertainties in Bayesian optimisation (2023)](https://arxiv.org/abs/2301.05983)) | Demonstrates that poorly calibrated uncertainties can degrade BO outcomes, motivating the need for “GP health” diagnostics when working with small datasets. |
| Surrogate model uncertainty quantification for reliability-based design optimization (2019) | [Surrogate model uncertainty quantification for reliability-based design optimization (2019)](https://www.sciencedirect.com/science/article/abs/pii/S0951832018305611) | Useful for justifying that GP uncertainty propagation is essential for safe or reliable decision-making under limited data. |
| Surrogate model uncertainty quantification for active learning reliability analysis (2024) | [Surrogate model uncertainty quantification for active learning reliability analysis (2024)](https://www.sciencedirect.com/science/article/pii/S1000936124003613) | Provides criteria to assess whether the GP is “good enough” to trust, aligning with health-gate logic in surrogate modeling. |
| Variational Bayesian surrogate modelling with application to robust design optimisation (2024) | [Variational Bayesian surrogate modelling with application to robust design optimisation (2024)](https://arxiv.org/abs/2404.14857) | Highlights advanced methods for uncertainty quantification, hyperparameter stability, and robustness under limited data, complementing vanilla GP approaches. |
| Uncertainty quantification and propagation in surrogate-based Bayesian inference (2025) | [Uncertainty quantification and propagation in surrogate-based Bayesian inference (2025)](https://link.springer.com/article/10.1007/s11222-025-10597-8) | Supports the practice of including GP predictive uncertainty in final decisions. |
